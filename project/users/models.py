...
class UserManager(BaseUserManager):
    ...
    def create_user(self, user_id, password, email, hp, name, student_id, grade, circles, auth, **extra_fields):
        if not user_id:
    ...
    def create_superuser(self, user_id, password, email=None, hp=None, name=None, student_id=None, grade=None, circles=None, auth=None):

        user = self.create_user(user_id, password, email, hp, name, student_id, grade, circles, auth)
